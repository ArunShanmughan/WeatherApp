...
function TempAndDetails({
  ...
  const verticalDetails = [
    ...
    { id: 2, Icon: BiSolidDroplet, title: "Humidity", value: `${humidity}%` },
  ...
  const horizontalDetails = [
    ...
    { id: 3, Icon: MdKeyboardArrowUp, title: "High", value: `${temp_max}°` },
    { id: 4, Icon: MdKeyboardArrowDown, title: "Low", value: `${temp_min}°` },
  ];
  ...
  return (
    <div>
      ...
      <div className="flex flex-row items-center justify-between py-3">
        <img
          src={icon} // Use the dynamic icon from the weather object
          alt="weather icon"
          className="w-20"
        />
